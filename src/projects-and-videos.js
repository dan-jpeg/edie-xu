const selectedWorks = [
    {
        ...
        duration: "15 min",
        media: [
            { type: "video", url: "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/videos/ceramic_metal_v01.mp4" },
            { type: "video", url: "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/videos/ceramic_metal_v02.mp4" },
    ...
    },
    {
        ...
        material: "stoneware",
        media: [
            { type: "image", url: "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/02-20_01.jpeg" },
            { type: "image", url: "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/02-20_02.jpeg" },
            { type: "image", url: "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/02-20_03.jpeg" }
        ]
    },
    {
        id: "2",
...
const exhibitions2 = [
    {
        ...
        textContent: "If, as Kant claimed, schematization is the very mechanism for human beings’ use of intelligence, then vision can be considered a premise for human reason. In the realm of contemporary art, OpArt once explored the relation between visual illusion and human cognition, involving whatgestalt psychology researched the correlation between perceptual fields and perceived objects. Inthe history of ideas, one can trace back to the studies on intentionality by Franz Brentano, aphilosopher and founder of act psychology from Austro-Hungarian Empire in the late 19thcentury. His significant contribution was to envisages the potential psychological objects as partsof something actual. In brief, within intentional activities, there exists an asymmetry betweencognition and consciousness, namely, the impossible of correspondence between perceivedobject and perception itself. Till to the aesthetic notion proposed by object-oriented ontology, thevery asymmetry expressed in artworks is categorized as “non-subjective correlation.” Therefore,the idea of arts is anchored based on a manifestation of impersonal elements. In the other words,the task of contemporary art aims to embody the concept of the “object-oriented”, in whichconsciousness, perception, and intentional activities of bodies are dominated by objects, andasymmetry is presented within such dominance. In this exhibition, we will see how differentartists’ works present various aspects of the object-oriented, whereby they try to express a non-subject correlated and asymmetry triggered by intentional activities. It can be said that if thesubjectivity and personality is posited as the ground of phenomenon, intentionality will be in intellectual concepts. How is emanation of intentionality possible? The asymmetrybrought by artistic ideas may be an answer.Cai Lei’s Works present a re-examination of asymmetry between daily visual perception andspatial cognition, in which the conventional notions of space are compressed that lead to anillusory experience of geometric vision.Hang Chun-hui’s pieces restructure human visual perception through the textures of differentmaterials, forming images that embody the ambiguity in a phenomenological sense, and thus theschematization is difficult to be determined.Liu Yue’s works attempt to explore the “directedness” of intentionality, for perception is alwaysdominated by vision. In his work, to highlight the asymmetry between cognition andconsciousness, visual perception is distorted or reduced to secondary perception.Su Chang’s works pinpoint the significance of the body schema to perception, which display thereversibility of bodies. In his works, the simulated limbs constitute the mirroring betweenperception and body sensation.Sun Wen-jia’s works delve into the relation between body schema and intentionality, with objects(lacquer and fossil) in his works implicating the history in a geological sense. Instead of subjectcorrelated thought, the artist’s works conversely initiate the discourse of objects.Xu Si-yi ‘s works reveal the effect of sexuality on intentional activities, where the relatiobetween body schema and eroticism always implies the object-oriented dimension.",
        workIncluded: [
            { id: 1, title: "Hear me sing", year: "2023", dimensions: "28 x 30 x 8 inches (71 x 78 x 20 cm)", material: "Unglazed stoneware", description: ""},
            { id: 2, title: "Thine air", year: "2023", dimensions: "34 x 23 x 15 inches (86 x 58 x 38cm)", material: "Unglazed stoneware", description: "the piece takes form as a nostalgia of ones embrace through the memories of my hands. The back of the piece is slightly cured and bent over showing subtle bumps of one’s spine, arched into a finger like tentacle. The piece is not glazed, it is made with two different clay, fired at 1800 degrees creating different texture and color. The black line in the middle of the ‘torso’ is inspired a daily life encounter of washing shrimp, and being surprised to realize they actually have two black vein instead of one" }
        ]
...

    {
        ...
        header: "Exhibited with Cheng Tingting, Chen Jiajun, Hu Longxiang, Xiong Haoqi, Xu Siyi, Wang Yuxiao, Zhou Tianyu",
        subheader: "",
        images: [
        ...
        footnote: "",
        workIncluded: [
            { id: 1, title: "Landmart", year: "2024", dimensions: "352 × 522 × 475 cm", material: "Knit, aluminum, cement residue", description: ""},
            { id: 2, title: "Intimate Being", year: "2023", dimensions: "40 × 25 × 25 cm", material: "Ceramics", description: "s embrace through the memories of my hands. The back of the piece is slightly cured and bent over showing subtle bumps of one’s spine, arched into a finger like tentacle. The piece is not glazed, it is made with two different clay, fired at 1800 degrees creating different texture and color. The black line in the middle of the ‘torso’ is inspired a daily life encounter of washing shrimp, and being surprised to realize they actually have two black vein instead of one" }
        ]
...

    {
        ...
        url:"https://sites.saic.edu/sitegalleries/2022/05/29/allure-of-the-abject/",
        header: "Exhibited with Anika Jeyaranjan, Dillon Bryant, Fernanda Carvalho Santos, Goldie, Inaara Vishnani, Maddie May, Riley Lynch, and Ryan Zhao",
        ...
        images:  [
            ...
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject05.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject06.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject07.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject08.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject09.png",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/allure-of-the-abject10.png",
        ],
        textContent: "In her seminal essay Powers of Horror: An Essay on Abjection (1982), Kristeva described the abject as “fear having been bracketed, … [in confrontation] with otherness, a burden both repellent and repelled, a deep well of memory that is unapproachable and intimate.” The abject involves a deconstructing and reconstituting of one’s sense of self, of peeling back the veneer of civility to see our true selves for what we are. It constitutes the liberation of our repressed subconscious and desires.Amidst increasing disenchantment with idealism and romanticism brought upon by our contemporary anxieties it seems we are pervaded by a sense of desolation. Disillusioned, many of us have begun making a turn towards the abject.",
        workIncluded: []
    },

    {
        ...
        url:"https://www.studiogallery.cn/zljt",
        header: "Group Exhibition with Cai Lei, Hang Chunhui, Liu Yue, Su Chang, Sun Wenjia",
...
Psychoanalysis: analysts mobilize their own activity and consciously experience the bodies of others, resulting in emotional resonance. In diagnosis and treatment, the analyst goes beyond the habitual perception of consciousness and pre-emotively identifies the minutiae of feelings in order to interact with the patient. Can we use this therapy to counteract the aphasia that is sensitive to materials in art viewing? From the level of feeling consciousness, the artist transfers, performs himself at the level of borrowing objects, and recognizes the expressions of objects with his own body sense. this process is like 'tuning' which is another term: adjusting the frequency of an oscillating electromagnetic wave so that it resonates with another oscillating electromagnetic wave. In the process of searching for radio stations in the noise, the artist uses the hand of his fingers to distinguish the wave band. In the process of distinguishing materials and feeling cultural symbols from natural skin, the artist captures imagination and intention with the common sense of materials and space, and reflects the different steps of feeling-awareness-image-concept step by step. 'thinking in images' is often used to describe the artist's thinking model against the logic of language. In contrast, the texture thinking' of thinking in the material is further materialized. The eleven creators/groups in this exhibition cut into their practice from different themes, from semantics, from fetishes, from embodied self-consciousness, from gender conventions, from social work against gender conventions, from texture memory, from the labor steps ofmaintaining or challenging media to form different textures of objects. Their respective frequencies infect, interfere and collaborate with each other in the same field, showing a slice of sculptural practice driven by material thinking. Test whether the empty frame of the sculpture can be filled with sufficient somatic processes to escape the trap of theory and bypass the spectacle of the installation.
...
-- Zhang yi`,
...

    {
        ...
        date: "2021",
        header: "161H x 169W x 146W inches",
        subheader: "Nylon, wall and fillings",
        images: [
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies01.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies02.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies03.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies04.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies05.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies06.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies07.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies08.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies09.jpg",
            "https://edie-xu-portfolio.s3.us-east-2.amazonaws.com/photos/outside-downscale/outside-of-bodies10.jpg",
        ],
        textcontent: "A series that I started working on in 2019, starting from on a 40 x 40 canvas. The installation is partly sewn with a sewing machine and hand stuffed throughout. Other areas are hand stitches before and during installation, and lastly negative spaces that are cut and torn for finishing touches. I was really interested in how one feels when they walk into the gallery space which is still something I am researching and diving deeper into, lot of light adjustments, including brightness, warmth, angel, shadows, and overall vibe. Space, spatial perception, interconnections, and changes as the audience walks to, around, and within. So before the actual piece was made, it was first a photo from different angles, sketches, and imagined measurements. Then blank canvases were hung, with ideas of the whole installation already in mind. Ladders were built and r hen it was the process of on-site sketching. After all pieces were sketched they were brought back to the studio to sew together. Brought back, reassembling, and slight changes, lastly the interconnecting tubes were shown by hand on sight as the width, tension, and length were then adjusted according to the whole thing.",
        footnote: "The form of the piece it self is a macroscopic view into the micro, into the abject and sacred. The stitched forms are replication of foot wrinkles",
        workIncluded: []
    },
